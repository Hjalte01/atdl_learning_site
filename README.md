...
Six topic routes; the twelve available papers for Topics 1 and 2 are catalogued. All six Topic 2 papers—FLUX.1 Kontext, DiffAtlas, REPA, Mean Flows, DiME and Qwen-Image—have full visual learning guides, equations and recall cards; Flux and DiffAtlas also include interactive illustrations. Qwen-Image adds ten reproducible SVG diagrams and eight cards based on the supplied 46-page arXiv v1 report, including dual conditioning, flow time direction, and text-rendering evidence. DiME adds eight reproducible SVG diagrams and eight cards based on the supplied 19-page ACCV 2022 paper, with explicit gradient-approximation and evaluation caveats. Mean Flows adds seven reproducible SVG diagrams, eight cards, and an architecture-to-math walkthrough based on the supplied 23-page NeurIPS 2025 conference PDF. REPA adds seven reproducible SVG diagrams and eight cards, based on the supplied 43-page ICLR 2025 PDF. DiffAtlas includes seven original diagrams and eight multiple-choice cards. Topics 3–6 await their actual titles and reading lists. Topic 1 now includes the Information Bottleneck guide (paper 1), with seven reproducible SVG diagrams and eight cards based on the supplied April 2017 v3 PDF; it distinguishes SGD training from IB analysis and exact from quantized information. Topic 1's grouping label remains provisional. Topic 1 also includes Nonvacuous Generalization Bounds (paper 2), with eight reproducible diagrams and eight cards based on the supplied October 2017 v2 PDF; it explains prior selection, posterior optimization, and Monte Carlo certification, and records source notation inconsistencies. Topic 1 paper 3, A Bayesian Perspective on SGD, adds seven reproducible diagrams and eight cards based on the supplied ICLR 2018 PDF; it connects evidence, coordinate invariance, finite-batch noise and momentum scaling. Topic 1 paper 4, Deep Double Descent, adds eight reproducible teaching diagrams, the supplied journal Figure 3 and eight cards, connecting effective model complexity to width, time and sample-size effects. It follows the December 2021 journal update and records source metric and budget inconsistencies. Topic 1 paper 5, Understanding Grokking, adds seven reproducible teaching diagrams, source Figure 4 and eight cards based on the supplied 13-page NeurIPS 2022 paper. It explains embedding transfer, constraint rank and decoder competition, with explicit normalization and missing-appendix caveats. Topic 1 paper 6, Binarized Networks and Compression, adds seven reproducible diagrams (including Table 3 correlation intervals) and eight cards based on the supplied May 2026 paper. It distinguishes diagnostic BDM from the training objective and records missing supplementary and implementation details. All twelve supplied papers now have guides. The Topic 2 Deep Generative Models reading overview also has a roadmap guide with six reproducible diagrams and eight cards, separating source claims from teaching equations and connecting all six Topic 2 papers.

The general *Principles and Practice of Deep Representation Learning* textbook (Version 2.0, March 1, 2026) now has a reading roadmap at `/papers/representation-overview`, with seven reproducible diagrams, worked PCA/denoising/coding-rate examples, selected Table 8.5 evidence and eight cards grouped under Topic 1. It remains unassigned to a numbered topic in the catalog; the guide header and return link support general material. This roadmap covers selected mechanisms and reading routes, not every chapter or experiment.
...
The general *Deep Learning is Not So Mysterious or Different* overview now has a guide at `/papers/not-so-mysterious`, following Wilson’s supplied July 10, 2025 arXiv v2. Six reproducible teaching diagrams, source Figure 5, worked polynomial and risk-bound examples, and eight Topic 1 foundation cards connect soft inductive biases with generalization. The guide flags the Gaussian-loss wording and singular least-squares inverse in the source; catalog classification remains general.

The general *Machine Learning: The Science of Selection under Uncertainty* overview now has a selective roadmap at `/papers/selection-under-uncertainty`, following Seldin’s supplied arXiv v2 (margin January 29, title page January 30, 2026). Seven reproducible SVGs, worked validation/PAC-Bayes/Hedge examples and eight Topic 1 foundation cards connect statistical selection to online feedback. It remains general material; this is not an exhaustive textbook review.

Topic 2’s *Deep Generative Models · Lecture 2* slide guide is complete at `/papers/t2-generative-lecture-2`. It follows the supplied 35-slide PDF (export metadata September 10, 2026), with seven reproducible SVG diagrams, worked DDPM/SDE/ODE/flow/attention/metric examples and eight Topic 2 cards. It distinguishes the lecture’s two time conventions and clarifies informal SDE notation. No cross-model benchmark results are invented from the survey slides.

The Topic 1 **Theories for Deep Learning** lecture (September 1, 2026) now has a slides guide at `/papers/t1-theories-lecture`, with seven reproducible teaching diagrams and eight cards. It connects all six Topic 1 papers, traces training versus diagnosis, and makes the assumptions behind PAC-Bayes, Laplace evidence and interpolation claims explicit.
